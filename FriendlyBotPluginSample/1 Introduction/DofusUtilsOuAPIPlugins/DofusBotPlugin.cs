...
[assembly: Plugin(typeof(FriendlyBotPluginSample.DofusUtilsOuAPIPlugins.DofusUtilsOuAPIPlugin), FriendlyBot.API.Enums.PluginType.DofusApiPlugin, "Mon premier plugin Friendlybot API (dofus)", "Exemple par Nicogo", "Pseudo")]
//[assembly: Plugin(typeof(FriendlyBotPluginSample.DofusUtilsOuAPIPlugins.DofusUtilsOuAPIPlugin), FriendlyBot.API.Enums.PluginType.DofusUtilsPlugin, "Mon premier plugin Friendlybot Utils (dofus)", "Exemple par Nicogo", "Pseudo")]

namespace FriendlyBotPluginSample.DofusUtilsOuAPIPlugins
{
