...
[assembly: Plugin(typeof(FriendlyBotPluginSample.DofusUtilsOuAPIPlugin), FriendlyBot.API.Enums.PluginType.DofusApiPlugin, "Mon premier plugin Friendlybot API (dofus)", "Exemple par Nicogo", "Pseudo")]
